...
urlpatterns = [
    ...
    path("api/whatsapp/session/<int:session_id>/", whatsapp_session_details_api, name="whatsapp_session_details_api"),
    path("api/whatsapp/event/", whatsapp_event_api, name="whatsapp_event_api"),
]
